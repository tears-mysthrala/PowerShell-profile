@{
    'Network' = @(
        @{
            ...
            'Path' = 'SystemTools\checkWifiPassword.ps1'
        }
        @{
            'Name' = 'CloudflareWARP'
            'Description' = 'Network tools'
            'Path' = 'SystemTools\cloudflareWARP.ps1'
        }
    )
    'Development' = @(
        @{
        ...
        @{
            ...
            'Path' = 'Apps\Configurations\stylus.ps1'
        }
    )
    'System' = @(
        @{
